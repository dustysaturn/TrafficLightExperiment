        ...
        while search_position := self.starting_rack.get_next_search_position(): 
            ...
            if not self.controller.vial_gripped():
                ...
                if not (empty_spot := self.finishing_rack.get_empty_spot()):
                    ...
                    # TODO: Add sequence of intermediate movements from above rim point to rim point
...
if __name__ == "__main__":
    ...
    experiment.setup_starting_rack(cols=4, rows=2, row_gap=0.025339683571428573, col_gap=0.0262839015, top_left_tcp=STARTING_TOP_LEFT)
